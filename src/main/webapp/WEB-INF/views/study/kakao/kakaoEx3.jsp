...
<p><br/></p>
<div class="container">
   	<h2>지역명으로 위치검색후 카카오DB에 저장된 '위도/경도'를 알아내어 MyDB에 저장하기</h2>
	<hr/>
    <!-- 지도를 표시할 div 입니다 -->
	<div id="map" style="width:100%;height:350px;"></div>
	<p><b>마커를 표시할 지도의 이치를 클릭해 주세요.</b></p>
	...
	<form name="myform">
		...
		<input type="hidden" name="selectLatitude" id="selectLatitude"/>
		<input type="hidden" name="selectLongitude" id="selectLongitude"/>
	</form>
	...
	function displayMarker(place) {
	    ...
	    kakao.maps.event.addListener(marker, 'click', function() {
	        ...
	        $("#selectLatitude").val(place.y);
	        $("#selectLongitude").val(place.x);
