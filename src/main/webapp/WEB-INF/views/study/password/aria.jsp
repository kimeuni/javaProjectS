...
<div class="container">
    <h2>ARIA</h2>
    <div>
    	ARIA암호화 방식은 경량환경 및 하드웨어 구현을 위해 최적화된 알골즘으로, Involutional SPN 구조를 갖는 범용블록 암호화 알고리즘이다.<br/>
		ARIA가 사용하는 연산은 대부분 XOR과 같은 단순한 바이트단위연산으로, 블록크기는 128Bit(총비트수 : 256Bit = 64문자)이다.
		ARIA는 Academy(학계),Research Institute(연구소), Agency(정부기관)의 첫글자를 따서 만들었다. <br/>
		AIRA암호화 방식은 복호화가 가능하다.
    </div>
    <br/>
    <div>
