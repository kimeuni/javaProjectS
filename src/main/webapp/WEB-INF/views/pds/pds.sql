...
create table review(
	...
	part varchar(20) not null,  		/* 항목 (board:게시판, pds:자료실 등..) */
...
select *,datediff(fDate,now()) as day_diff, timestampdiff(hour,fDate,now()) as hour_diff from pds  order by idx desc